...
public class MainScreenold extends HttpServlet {


    static Logger logger = Logger.getLogger(MainScreenold.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String redirectURL = "/PaymentSystemSwipe/secureUser/home.jsp";
            ...
            try
            {
                ...
                while(rsselect.next())
                {
                    ...
                    out.println("<hr><b>Welcome PaymentSystemSwipe</b> ");
                    out.println("<center><button type=\"button\" onclick =\"document.location.href = '/PaymentSystemSwipe/secureUser/home.jsp'\">Continue</button></center> <br /> ");
