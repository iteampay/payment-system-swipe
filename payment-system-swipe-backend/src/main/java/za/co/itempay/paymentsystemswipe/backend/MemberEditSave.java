 ...
 */
@WebServlet(name = "MemberEditSave", urlPatterns = {"/MemberEditSave"})
public class MemberEditSave extends HttpServlet {


    static Logger logger = Logger.getLogger(MemberEditSave.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logger.info("MemberEditSave accessed by: " + User);
            ...
            try {
                ...
                date = new Date();
                logger.debug(dateFormat.format(date));
                logger.debug("Query: update T_BP_Customers set FirstName = '" + FirstName + "', SurName = '" + SurName + "', Initials = '" + Initials + "', Title = '" + Title + "', Sex = '" + Sex + "', Marital_Status = '" + Marital_Status + "', Identity_No = '" + Identity_No + "', Physical_Address_Line1 = '" + Physical_Address_Line1 + "', Physical_Address_Line2 = '" + Physical_Address_Line2 + "', Physical_Address_Town = '" + Physical_Address_Town + "', Physical_Address_Region = '" + Physical_Address_Region + "', Physical_Address_Country = '" + Physical_Address_Country + "', Home_Phone_No = '" + Home_Phone_No + "', Mobile = '" + Mobile + "', EMail = '" + EMail + "', Member_No = '" + Member_No + "' where BP_Cust_ID = '" + BP_Cust_ID + "'");
                stinsert.executeUpdate("update T_BP_Customers set FirstName = '" + FirstName + "', SurName = '" + SurName + "', Initials = '" + Initials + "', Title = '" + Title + "', Sex = '" + Sex + "', Marital_Status = '" + Marital_Status + "', Identity_No = '" + Identity_No + "', Physical_Address_Line1 = '" + Physical_Address_Line1 + "', Physical_Address_Line2 = '" + Physical_Address_Line2 + "', Physical_Address_Town = '" + Physical_Address_Town + "', Physical_Address_Region = '" + Physical_Address_Region + "', Physical_Address_Country = '" + Physical_Address_Country + "', Home_Phone_No = '" + Home_Phone_No + "', Mobile = '" + Mobile + "', EMail = '" + EMail + "', Member_No = '" + Member_No + "' where BP_Cust_ID = '" + BP_Cust_ID + "'");
            } catch (SQLException ex) {
                date = new Date();
                logger.fatal(dateFormat.format(date));
                logger.fatal("SQLException " + ex.getMessage());
                logger.fatal("With query: update T_BP_Customers set FirstName = '" + FirstName + "', SurName = '" + SurName + "', Initials = '" + Initials + "', Title = '" + Title + "', Sex = '" + Sex + "', Marital_Status = '" + Marital_Status + "', Identity_No = '" + Identity_No + "', Physical_Address_Line1 = '" + Physical_Address_Line1 + "', Physical_Address_Line2 = '" + Physical_Address_Line2 + "', Physical_Address_Town = '" + Physical_Address_Town + "', Physical_Address_Region = '" + Physical_Address_Region + "', Physical_Address_Country = '" + Physical_Address_Country + "', Home_Phone_No = '" + Home_Phone_No + "', Mobile = '" + Mobile + "', EMail = '" + EMail + "', Member_No = '" + Member_No + "' where BP_Cust_ID = '" + BP_Cust_ID + "'");
            }
            ...
            out.println("        <title>Member Updated</title>");
            out.println("    </head>");
            out.println("    <body>");
            ...
            out.println("					<h3>Member details updated</h3>");
            out.println("					</div>");
            out.println("				</div>");
            out.println("			</div>");
            ...
            out.println("<h2><font color='red'><center>Member details updated</center></font></h2>");
