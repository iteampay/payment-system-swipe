...
@WebServlet(name = "FuneralMProfitability", urlPatterns = {"/FuneralMProfitability"})
public class FuneralMProfitability extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String RAgentName = request.getParameter("Agent");
        logger.info("Beneficiary: " + RAgentName);
        Beneficiary_No = RAgentName.substring(0, 4);
        logger.info("Beneficiary no akhona: " + Beneficiary_No);
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    date = new Date();
                    logger.debug(dateFormat.format(date));
                    logger.debug("Query:SELECT SUM(A.Amount)FROM T_EasyPay_Messages A, T_BP_Beneficiaries B WHERE a.Settled = 'N' AND a.beneficiary_no = b.beneficiary_no AND A.Deleted = 'N' AND B.Split = 1  ");
                    ResultSet rsselect = stselect.executeQuery("Query:SELECT SUM(Amount)FROM T_EasyPay_Messages WHERE DATENAME(MONTH,File_Date_Time)= 'July' AND DATENAME(YEAR,File_Date_Time)= '2013'  ");
                    ...
                    rsselect = stselect.executeQuery("Query:SELECT COUNT(*)FROM T_EasyPay_Messages WHERE DATENAME(MONTH,File_Date_Time)= 'July' AND DATENAME(YEAR,File_Date_Time)= '2013'");
                    ...
                    rsselect = stselect.executeQuery("Query:SELECT SUM(EP_Fee)FROM T_EasyPay_Messages WHERE DATENAME(MONTH,File_Date_Time)= 'July'AND DATENAME(YEAR,File_Date_Time)= '2013' ");
                    ...
                    rsselect = stselect.executeQuery("Query:SELECT SUM(Bank_cost)FROM T_EasyPay_Messages WHERE DATENAME(MONTH,File_Date_Time)= 'July'AND DATENAME(YEAR,File_Date_Time)= '2013'");
                    ...
                    rsselect = stselect.executeQuery("Query:SELECT SUM(Other_Fee)FROM T_EasyPay_Messages WHERE DATENAME(MONTH,File_Date_Time)= 'July'AND DATENAME(YEAR,File_Date_Time)= '2013'");
                    ...
                    rsselect = stselect.executeQuery("Query:SELECT SUM(TP_Fee)FROM T_EasyPay_Messages WHERE DATENAME(MONTH,File_Date_Time)= 'July' AND DATENAME(YEAR,File_Date_Time)= '2013'  ");
                ...
                logger.debug("SettelmentAmount: " + SettelmentAmount);*/
                    ...
                    rsselect = stselect.executeQuery("Query:SELECT SUM(Amount)FROM T_EasyPay_Messages WHERE DATENAME(MONTH,File_Date_Time)= 'July'AND DATENAME(YEAR,File_Date_Time)= '2013'AND Tender_Type = 'Cash'  ");
                    ...
                    rsselect = stselect.executeQuery("Query:select count(*) FROM T_EasyPay_Messages WHERE DATENAME(MONTH,File_Date_Time)= 'July'AND DATENAME(YEAR,File_Date_Time)= '2013'AND Tender_Type = 'Cash' ");
                    ...
                    rsselect = stselect.executeQuery("Query:select ltrim(rtrim(str(sum(Amount), 13, 2))) FROM T_EasyPay_Messages WHERE DATENAME(MONTH,File_Date_Time)= 'July'AND DATENAME(YEAR,File_Date_Time)= '2013'AND Tender_Type = 'Cheque' ");
                    ...
                    rsselect = stselect.executeQuery("Query:select count(*)  FROM T_EasyPay_Messages WHERE DATENAME(MONTH,File_Date_Time)= 'July'AND DATENAME(YEAR,File_Date_Time)= '2013'AND Tender_Type = 'Cheque' ");
                    ...
                    rsselect = stselect.executeQuery("Query:select ltrim(rtrim(str(sum(Amount), 13, 2)))  FROM T_EasyPay_Messages WHERE DATENAME(MONTH,File_Date_Time)= 'July'AND DATENAME(YEAR,File_Date_Time)= '2013'AND Tender_Type = 'CreditCard' ");
                    ...
                    rsselect = stselect.executeQuery("Query:select count(*) FROM T_EasyPay_Messages WHERE DATENAME(MONTH,File_Date_Time)= 'July'AND DATENAME(YEAR,File_Date_Time)= '2013'AND Tender_Type = 'CreditCard' ");
                    ...
                    rsselect = stselect.executeQuery("Query:select ltrim(rtrim(str(sum(Amount), 13, 2))) FROM T_EasyPay_Messages WHERE DATENAME(MONTH,File_Date_Time)= 'July'AND DATENAME(YEAR,File_Date_Time)= '2013'AND (Tender_Type = 'CreditEFT' or Tender_Type = 'EFT' )");
                    ...
                    rsselect = stselect.executeQuery("Query:select count(*) FROM T_EasyPay_Messages WHERE DATENAME(MONTH,File_Date_Time)= 'July'AND DATENAME(YEAR,File_Date_Time)= '2013'AND Tender_Type = 'EFT' ");
...
//AND D.Deleted = 'N'       ");         
                    ...
                    out.println("					<h3>Monthly profitability</h3>");
