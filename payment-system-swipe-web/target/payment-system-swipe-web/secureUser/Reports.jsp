<%-- 
    Document   : Reports
    Created on : 2013/02/07, 12:06:06
    Author     : akhona
--%>
...
<div id="wrapper">
		...
		<ul id="menu" class="cleaning-box">
			...
			<li><a href="/payment-system-swipe-web/secureUser/Reports.jsp" class="active">Reports</a></li>
		...
		<div id="content-box-in">
			...
			<div class="content-box">
				<div class="content-box-in">
					<h3>Please select a report to run from the links above</h3>
                                        <b />
                                        <b />
                                        <b />
                                        <b />
