<%-- 
    Document   : Unpaids
    Created on : 2013/02/08, 10:40:40
    Author     : akhona
--%>
...
<div id="wrapper">
		...
		<li class="first"><a href="/payment-system-swipe-web/secureUser/home.jsp" >Home</a></li>
			...
			<li><a href="/payment-system-swipe-web/secureAdmin/MemberCashPayment.jsp">Process a Payment</a></li>
                        ...
                        <li><a href="/payment-system-swipe-web/secureUser/Reports.jsp">          </a></li>
                        <li><a href="/payment-system-swipe-web/secureUser/Payments.jsp"  > Payment Report</a></li>
                        <li><a href="/payment-system-swipe-web/secureAdmin/Unpaid.jsp" class="active"> Unpaid Report</a></li>
		</ul>
		<!-- Menu end -->
...
<hr class="noscreen" />
	...
	<div id="content-box">
        ...
        <form name="dbmanagement" method="post" action="../Unpaid_Report">
            ...
            <center><input type="submit" value="Proceed" name="Unpaid_Reports"></center>
