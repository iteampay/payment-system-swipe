<%-- 
    Document   : ProcessingSwipe
    Created on : 07 Sep 2015, 12:58:39 PM
    Author     : Billy
--%>
                ...
                <div id="content-box-in">
                    ...
                    <div class="content-box">
                        <div class="content-box-in">
                            ...
                            <form name="Processing" method="post" action="../Add_NewMember">
                                <script type="text/javascript">
                                    disableSelection(document.body) //disable text selection on entire body of page 
                                </script>
                                <center><img src="/PaymentSystemSwipe/img/Processing.gif" border="0" alt="Payment method."></center>
                                
                                <input class="hiddenField" type="hidden" name="EMPPAN" value="<%=EMPPAN%>"/>
